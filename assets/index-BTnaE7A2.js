 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,G){var X=z.length;z.push(G);e:for(;0<X;){var ge=X-1>>>1,le=z[ge];if(0<i(le,G))z[ge]=G,z[X]=le,X=ge;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var G=z[0],X=z.pop();if(X!==G){z[0]=X;e:for(var ge=0,le=z.length,Ie=le>>>1;ge<Ie;){var Jt=2*(ge+1)-1,Zt=z[Jt],en=Jt+1,tn=z[en];if(0>i(Zt,X))en<le&&0>i(tn,Zt)?(z[ge]=tn,z[en]=X,ge=en):(z[ge]=Zt,z[Jt]=X,ge=Jt);else if(en<le&&0>i(tn,X))z[ge]=tn,z[en]=X,ge=en;else break e}}return G}function i(z,G){var X=z.sortIndex-G.sortIndex;return X!==0?X:z.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,_=3,R=!1,C=!1,D=!1,M=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(z){for(var G=n(h);G!==null;){if(G.callback===null)r(h);else if(G.startTime<=z)r(h),G.sortIndex=G.expirationTime,e(u,G);else break;G=n(h)}}function V(z){if(D=!1,S(z),!C)if(n(u)!==null)C=!0,Wi(j);else{var G=n(h);G!==null&&Xt(V,G.startTime-z)}}function j(z,G){C=!1,D&&(D=!1,I(m),m=-1),R=!0;var X=_;try{for(S(G),g=n(u);g!==null&&(!(g.expirationTime>G)||z&&!A());){var ge=g.callback;if(typeof ge=="function"){g.callback=null,_=g.priorityLevel;var le=ge(g.expirationTime<=G);G=t.unstable_now(),typeof le=="function"?g.callback=le:g===n(u)&&r(u),S(G)}else r(u);g=n(u)}if(g!==null)var Ie=!0;else{var Jt=n(h);Jt!==null&&Xt(V,Jt.startTime-G),Ie=!1}return Ie}finally{g=null,_=X,R=!1}}var F=!1,v=null,m=-1,y=5,E=-1;function A(){return!(t.unstable_now()-E<y)}function k(){if(v!==null){var z=t.unstable_now();E=z;var G=!0;try{G=v(!0,z)}finally{G?T():(F=!1,v=null)}}else F=!1}var T;if(typeof w=="function")T=function(){w(k)};else if(typeof MessageChannel<"u"){var wt=new MessageChannel,dr=wt.port2;wt.port1.onmessage=k,T=function(){dr.postMessage(null)}}else T=function(){M(k,0)};function Wi(z){v=z,F||(F=!0,T())}function Xt(z,G){m=M(function(){z(t.unstable_now())},G)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){C||R||(C=!0,Wi(j))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):y=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return _},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(_){case 1:case 2:case 3:var G=3;break;default:G=_}var X=_;_=G;try{return z()}finally{_=X}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,G){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var X=_;_=z;try{return G()}finally{_=X}},t.unstable_scheduleCallback=function(z,G,X){var ge=t.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?ge+X:ge):X=ge,z){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=X+le,z={id:f++,callback:G,priorityLevel:z,startTime:X,expirationTime:le,sortIndex:-1},X>ge?(z.sortIndex=X,e(h,z),n(u)===null&&z===n(h)&&(D?(I(m),m=-1):D=!0,Xt(V,X-ge))):(z.sortIndex=le,e(u,z),C||R||(C=!0,Wi(j))),z},t.unstable_shouldYield=A,t.unstable_wrapCallback=function(z){var G=_;return function(){var X=_;_=G;try{return z.apply(this,arguments)}finally{_=X}}}})(e_);Zg.exports=e_;var g0=Zg.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZS(t){Ri(new Vr("platform-logger",e=>new dS(e),"PRIVATE")),Ri(new Vr("heartbeat",e=>new YS(e),"PRIVATE")),Xn(oh,Pm,t),Xn(oh,Pm,"esm2017"),Xn("fire-js","")}ZS("");var Vm=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Rr,dv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(v,m){function y(){}y.prototype=m.prototype,v.D=m.prototype,v.prototype=new y,v.prototype.constructor=v,v.C=function(E,A,k){for(var T=Array(arguments.length-2),wt=2;wt<arguments.length;wt++)T[wt-2]=arguments[wt];return m.prototype[A].apply(E,T)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,m,y){y||(y=0);var E=Array(16);if(typeof m=="string")for(var A=0;16>A;++A)E[A]=m.charCodeAt(y++)|m.charCodeAt(y++)<<8|m.charCodeAt(y++)<<16|m.charCodeAt(y++)<<24;else for(A=0;16>A;++A)E[A]=m[y++]|m[y++]<<8|m[y++]<<16|m[y++]<<24;m=v.g[0],y=v.g[1],A=v.g[2];var k=v.g[3],T=m+(k^y&(A^k))+E[0]+3614090360&4294967295;m=y+(T<<7&4294967295|T>>>25),T=k+(A^m&(y^A))+E[1]+3905402710&4294967295,k=m+(T<<12&4294967295|T>>>20),T=A+(y^k&(m^y))+E[2]+606105819&4294967295,A=k+(T<<17&4294967295|T>>>15),T=y+(m^A&(k^m))+E[3]+3250441966&4294967295,y=A+(T<<22&4294967295|T>>>10),T=m+(k^y&(A^k))+E[4]+4118548399&4294967295,m=y+(T<<7&4294967295|T>>>25),T=k+(A^m&(y^A))+E[5]+1200080426&4294967295,k=m+(T<<12&4294967295|T>>>20),T=A+(y^k&(m^y))+E[6]+2821735955&4294967295,A=k+(T<<17&4294967295|T>>>15),T=y+(m^A&(k^m))+E[7]+4249261313&4294967295,y=A+(T<<22&4294967295|T>>>10),T=m+(k^y&(A^k))+E[8]+1770035416&4294967295,m=y+(T<<7&4294967295|T>>>25),T=k+(A^m&(y^A))+E[9]+2336552879&4294967295,k=m+(T<<12&4294967295|T>>>20),T=A+(y^k&(m^y))+E[10]+4294925233&4294967295,A=k+(T<<17&4294967295|T>>>15),T=y+(m^A&(k^m))+E[11]+2304563134&4294967295,y=A+(T<<22&4294967295|T>>>10),T=m+(k^y&(A^k))+E[12]+1804603682&4294967295,m=y+(T<<7&4294967295|T>>>25),T=k+(A^m&(y^A))+E[13]+4254626195&4294967295,k=m+(T<<12&4294967295|T>>>20),T=A+(y^k&(m^y))+E[14]+2792965006&4294967295,A=k+(T<<17&4294967295|T>>>15),T=y+(m^A&(k^m))+E[15]+1236535329&4294967295,y=A+(T<<22&4294967295|T>>>10),T=m+(A^k&(y^A))+E[1]+4129170786&4294967295,m=y+(T<<5&4294967295|T>>>27),T=k+(y^A&(m^y))+E[6]+3225465664&4294967295,k=m+(T<<9&4294967295|T>>>23),T=A+(m^y&(k^m))+E[11]+643717713&4294967295,A=k+(T<<14&4294967295|T>>>18),T=y+(k^m&(A^k))+E[0]+3921069994&4294967295,y=A+(T<<20&4294967295|T>>>12),T=m+(A^k&(y^A))+E[5]+3593408605&4294967295,m=y+(T<<5&4294967295|T>>>27),T=k+(y^A&(m^y))+E[10]+38016083&4294967295,k=m+(T<<9&4294967295|T>>>23),T=A+(m^y&(k^m))+E[15]+3634488961&4294967295,A=k+(T<<14&4294967295|T>>>18),T=y+(k^m&(A^k))+E[4]+3889429448&4294967295,y=A+(T<<20&4294967295|T>>>12),T=m+(A^k&(y^A))+E[9]+568446438&4294967295,m=y+(T<<5&4294967295|T>>>27),T=k+(y^A&(m^y))+E[14]+3275163606&4294967295,k=m+(T<<9&4294967295|T>>>23),T=A+(m^y&(k^m))+E[3]+4107603335&4294967295,A=k+(T<<14&4294967295|T>>>18),T=y+(k^m&(A^k))+E[8]+1163531501&4294967295,y=A+(T<<20&4294967295|T>>>12),T=m+(A^k&(y^A))+E[13]+2850285829&4294967295,m=y+(T<<5&4294967295|T>>>27),T=k+(y^A&(m^y))+E[2]+4243563512&4294967295,k=m+(T<<9&4294967295|T>>>23),T=A+(m^y&(k^m))+E[7]+1735328473&4294967295,A=k+(T<<14&4294967295|T>>>18),T=y+(k^m&(A^k))+E[12]+2368359562&4294967295,y=A+(T<<20&4294967295|T>>>12),T=m+(y^A^k)+E[5]+4294588738&4294967295,m=y+(T<<4&4294967295|T>>>28),T=k+(m^y^A)+E[8]+2272392833&4294967295,k=m+(T<<11&4294967295|T>>>21),T=A+(k^m^y)+E[11]+1839030562&4294967295,A=k+(T<<16&4294967295|T>>>16),T=y+(A^k^m)+E[14]+4259657740&4294967295,y=A+(T<<23&4294967295|T>>>9),T=m+(y^A^k)+E[1]+2763975236&4294967295,m=y+(T<<4&4294967295|T>>>28),T=k+(m^y^A)+E[4]+1272893353&4294967295,k=m+(T<<11&4294967295|T>>>21),T=A+(k^m^y)+E[7]+4139469664&4294967295,A=k+(T<<16&4294967295|T>>>16),T=y+(A^k^m)+E[10]+3200236656&4294967295,y=A+(T<<23&4294967295|T>>>9),T=m+(y^A^k)+E[13]+681279174&4294967295,m=y+(T<<4&4294967295|T>>>28),T=k+(m^y^A)+E[0]+3936430074&4294967295,k=m+(T<<11&4294967295|T>>>21),T=A+(k^m^y)+E[3]+3572445317&4294967295,A=k+(T<<16&4294967295|T>>>16),T=y+(A^k^m)+E[6]+76029189&4294967295,y=A+(T<<23&4294967295|T>>>9),T=m+(y^A^k)+E[9]+3654602809&4294967295,m=y+(T<<4&4294967295|T>>>28),T=k+(m^y^A)+E[12]+3873151461&4294967295,k=m+(T<<11&4294967295|T>>>21),T=A+(k^m^y)+E[15]+530742520&4294967295,A=k+(T<<16&4294967295|T>>>16),T=y+(A^k^m)+E[2]+3299628645&4294967295,y=A+(T<<23&4294967295|T>>>9),T=m+(A^(y|~k))+E[0]+4096336452&4294967295,m=y+(T<<6&4294967295|T>>>26),T=k+(y^(m|~A))+E[7]+1126891415&4294967295,k=m+(T<<10&4294967295|T>>>22),T=A+(m^(k|~y))+E[14]+2878612391&4294967295,A=k+(T<<15&4294967295|T>>>17),T=y+(k^(A|~m))+E[5]+4237533241&4294967295,y=A+(T<<21&4294967295|T>>>11),T=m+(A^(y|~k))+E[12]+1700485571&4294967295,m=y+(T<<6&4294967295|T>>>26),T=k+(y^(m|~A))+E[3]+2399980690&4294967295,k=m+(T<<10&4294967295|T>>>22),T=A+(m^(k|~y))+E[10]+4293915773&4294967295,A=k+(T<<15&4294967295|T>>>17),T=y+(k^(A|~m))+E[1]+2240044497&4294967295,y=A+(T<<21&4294967295|T>>>11),T=m+(A^(y|~k))+E[8]+1873313359&4294967295,m=y+(T<<6&4294967295|T>>>26),T=k+(y^(m|~A))+E[15]+4264355552&4294967295,k=m+(T<<10&4294967295|T>>>22),T=A+(m^(k|~y))+E[6]+2734768916&4294967295,A=k+(T<<15&4294967295|T>>>17),T=y+(k^(A|~m))+E[13]+1309151649&4294967295,y=A+(T<<21&4294967295|T>>>11),T=m+(A^(y|~k))+E[4]+4149444226&4294967295,m=y+(T<<6&4294967295|T>>>26),T=k+(y^(m|~A))+E[11]+3174756917&4294967295,k=m+(T<<10&4294967295|T>>>22),T=A+(m^(k|~y))+E[2]+718787259&4294967295,A=k+(T<<15&4294967295|T>>>17),T=y+(k^(A|~m))+E[9]+3951481745&4294967295,v.g[0]=v.g[0]+m&4294967295,v.g[1]=v.g[1]+(A+(T<<21&4294967295|T>>>11))&4294967295,v.g[2]=v.g[2]+A&4294967295,v.g[3]=v.g[3]+k&4294967295}r.prototype.u=function(v,m){m===void 0&&(m=v.length);for(var y=m-this.blockSize,E=this.B,A=this.h,k=0;k<m;){if(A==0)for(;k<=y;)i(this,v,k),k+=this.blockSize;if(typeof v=="string"){for(;k<m;)if(E[A++]=v.charCodeAt(k++),A==this.blockSize){i(this,E),A=0;break}}else for(;k<m;)if(E[A++]=v[k++],A==this.blockSize){i(this,E),A=0;break}}this.h=A,this.o+=m},r.prototype.v=function(){var v=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);v[0]=128;for(var m=1;m<v.length-8;++m)v[m]=0;var y=8*this.o;for(m=v.length-8;m<v.length;++m)v[m]=y&255,y/=256;for(this.u(v),v=Array(16),m=y=0;4>m;++m)for(var E=0;32>E;E+=8)v[y++]=this.g[m]>>>E&255;return v};function s(v,m){var y=l;return Object.prototype.hasOwnProperty.call(y,v)?y[v]:y[v]=m(v)}function o(v,m){this.h=m;for(var y=[],E=!0,A=v.length-1;0<=A;A--){var k=v[A]|0;E&&k==m||(y[A]=k,E=!1)}this.g=y}var l={};function u(v){return-128<=v&&128>v?s(v,function(m){return new o([m|0],0>m?-1:0)}):new o([v|0],0>v?-1:0)}function h(v){if(isNaN(v)||!isFinite(v))return g;if(0>v)return M(h(-v));for(var m=[],y=1,E=0;v>=y;E++)m[E]=v/y|0,y*=4294967296;return new o(m,0)}function f(v,m){if(v.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(v.charAt(0)=="-")return M(f(v.substring(1),m));if(0<=v.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=h(Math.pow(m,8)),E=g,A=0;A<v.length;A+=8){var k=Math.min(8,v.length-A),T=parseInt(v.substring(A,A+k),m);8>k?(k=h(Math.pow(m,k)),E=E.j(k).add(h(T))):(E=E.j(y),E=E.add(h(T)))}return E}var g=u(0),_=u(1),R=u(16777216);t=o.prototype,t.m=function(){if(D(this))return-M(this).m();for(var v=0,m=1,y=0;y<this.g.length;y++){var E=this.i(y);v+=(0<=E?E:4294967296+E)*m,m*=4294967296}return v},t.toString=function(v){if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(C(this))return"0";if(D(this))return"-"+M(this).toString(v);for(var m=h(Math.pow(v,6)),y=this,E="";;){var A=V(y,m).g;y=I(y,A.j(m));var k=((0<y.g.length?y.g[0]:y.h)>>>0).toString(v);if(y=A,C(y))return k+E;for(;6>k.length;)k="0"+k;E=k+E}},t.i=function(v){return 0>v?0:v<this.g.length?this.g[v]:this.h};function C(v){if(v.h!=0)return!1;for(var m=0;m<v.g.length;m++)if(v.g[m]!=0)return!1;return!0}function D(v){return v.h==-1}t.l=function(v){return v=I(this,v),D(v)?-1:C(v)?0:1};function M(v){for(var m=v.g.length,y=[],E=0;E<m;E++)y[E]=~v.g[E];return new o(y,~v.h).add(_)}t.abs=function(){return D(this)?M(this):this},t.add=function(v){for(var m=Math.max(this.g.length,v.g.length),y=[],E=0,A=0;A<=m;A++){var k=E+(this.i(A)&65535)+(v.i(A)&65535),T=(k>>>16)+(this.i(A)>>>16)+(v.i(A)>>>16);E=T>>>16,k&=65535,T&=65535,y[A]=T<<16|k}return new o(y,y[y.length-1]&-2147483648?-1:0)};function I(v,m){return v.add(M(m))}t.j=function(v){if(C(this)||C(v))return g;if(D(this))return D(v)?M(this).j(M(v)):M(M(this).j(v));if(D(v))return M(this.j(M(v)));if(0>this.l(R)&&0>v.l(R))return h(this.m()*v.m());for(var m=this.g.length+v.g.length,y=[],E=0;E<2*m;E++)y[E]=0;for(E=0;E<this.g.length;E++)for(var A=0;A<v.g.length;A++){var k=this.i(E)>>>16,T=this.i(E)&65535,wt=v.i(A)>>>16,dr=v.i(A)&65535;y[2*E+2*A]+=T*dr,w(y,2*E+2*A),y[2*E+2*A+1]+=k*dr,w(y,2*E+2*A+1),y[2*E+2*A+1]+=T*wt,w(y,2*E+2*A+1),y[2*E+2*A+2]+=k*wt,w(y,2*E+2*A+2)}for(E=0;E<m;E++)y[E]=y[2*E+1]<<16|y[2*E];for(E=m;E<2*m;E++)y[E]=0;return new o(y,0)};function w(v,m){for(;(v[m]&65535)!=v[m];)v[m+1]+=v[m]>>>16,v[m]&=65535,m++}function S(v,m){this.g=v,this.h=m}function V(v,m){if(C(m))throw Error("division by zero");if(C(v))return new S(g,g);if(D(v))return m=V(M(v),m),new S(M(m.g),M(m.h));if(D(m))return m=V(v,M(m)),new S(M(m.g),m.h);if(30<v.g.length){if(D(v)||D(m))throw Error("slowDivide_ only works with positive integers.");for(var y=_,E=m;0>=E.l(v);)y=j(y),E=j(E);var A=F(y,1),k=F(E,1);for(E=F(E,2),y=F(y,2);!C(E);){var T=k.add(E);0>=T.l(v)&&(A=A.add(y),k=T),E=F(E,1),y=F(y,1)}return m=I(v,A.j(m)),new S(A,m)}for(A=g;0<=v.l(m);){for(y=Math.max(1,Math.floor(v.m()/m.m())),E=Math.ceil(Math.log(y)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),k=h(y),T=k.j(m);D(T)||0<T.l(v);)y-=E,k=h(y),T=k.j(m);C(k)&&(k=_),A=A.add(k),v=I(v,T)}return new S(A,v)}t.A=function(v){return V(this,v).h},t.and=function(v){for(var m=Math.max(this.g.length,v.g.length),y=[],E=0;E<m;E++)y[E]=this.i(E)&v.i(E);return new o(y,this.h&v.h)},t.or=function(v){for(var m=Math.max(this.g.length,v.g.length),y=[],E=0;E<m;E++)y[E]=this.i(E)|v.i(E);return new o(y,this.h|v.h)},t.xor=function(v){for(var m=Math.max(this.g.length,v.g.length),y=[],E=0;E<m;E++)y[E]=this.i(E)^v.i(E);return new o(y,this.h^v.h)};function j(v){for(var m=v.g.length+1,y=[],E=0;E<m;E++)y[E]=v.i(E)<<1|v.i(E-1)>>>31;return new o(y,v.h)}function F(v,m){var y=m>>5;m%=32;for(var E=v.g.length-y,A=[],k=0;k<E;k++)A[k]=0<m?v.i(k+y)>>>m|v.i(k+y+1)<<32-m:v.i(k+y);return new o(A,v.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,dv=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Rr=o}).apply(typeof Vm<"u"?Vm:typeof self<"u"?self:typeof window<"u"?window:{});var ca=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ih(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function wk(){return yg()==="http:"||yg()==="https:"}function yg(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ek(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(wk()||OI()||"connection"in navigator)?navigator.onLine:!0}function Tk(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gi{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){H(e.idToken,"internal-error"),H(typeof e.idToken<"u","internal-error"),H(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):wg(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){H(e.length!==0,"internal-error");const n=wg(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(H(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await Lk(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,o=new gi;return r&&(H(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),i&&(H(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(H(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new gi,this.toJSON())}_performRefresh(){return un("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aC(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function lC(t){const e=_s(ys(t)).link,n=e?_s(ys(e)).deep_link_id:null,r=_s(ys(t)).deep_link_id;return(r?_s(ys(r)).link:null)||r||n||e||t}class hf{constructor(e){var n,r,i,s,o,l;const u=_s(ys(e)),h=(n=u.apiKey)!==null&&n!==void 0?n:null,f=(r=u.oobCode)!==null&&r!==void 0?r:null,g=aC((i=u.mode)!==null&&i!==void 0?i:null);H(h&&f&&g,"argument-error"),this.apiKey=h,this.operation=g,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=lC(e);try{return new hf(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g1="__/auth/handler",_1="emulator/auth/handler",y1=encodeURIComponent("fac");async function Og(t,e,n,r,i,s){H(t.config.authDomain,t,"auth-domain-config-required"),H(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:bi,eventId:i};if(e instanceof Xw){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",$I(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,g]of Object.entries({}))o[f]=g}if(e instanceof Po){const f=e.getScopes().filter(g=>g!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${y1}=${encodeURIComponent(u)}`:"";return`${v1(t)}?${yo(l).slice(1)}${h}`}function v1({config:t}){return t.emulator?af(t,_1):`https://${t.authDomain}/${g1}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
